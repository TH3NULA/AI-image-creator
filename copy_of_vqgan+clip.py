# -*- coding: utf-8 -*-
"""Copy of VQGAN+CLIP.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/119ZKGorMEfyPb_of2BYLrt-EZx5Di81x

# How to Generate MIND-BLOWING A.I. Art in 5 Minutes!!

**5 minute Tutorial: https://www.youtube.com/watch?v=2hgfbf5OOoI**

Original Notebook made by Thenula Dinal (https://github.com/TH3NULA, 

If you want to Show/Hide a code block go to View>Show/Hide Code Block

***If you get any type of weird error (library not found, memory error etc) try to Runtime> Factory Reset Runtime and try again. This solves 99% of problems***
"""

!nvidia-smi

#@title Download Required Python Packages (MAKE SURE TO RUN)
...
#@title Choose Model to Download (MAKE SURE TO RUN)
...
# @title Download Libraries for Neural Network (MAKE SURE TO RUN)
...
#@title Parameters for Neural Network (MAKE SURE TO RUN THIS BLOCK)
text = "Astronaut in the Ocean by Greg Rutkowski" #@param {type:"string"}
textos = text
...
modelo=model
interval_image =  100#@param {type:"number"}
...
"""# **Optional Step 1) ESRGAN for increasing resolution**
...
# Commented out IPython magic to ensure Python compatibility.
#@markdown # **Upload image! You need to Download the Generated Image beforehand.**
...
# Commented out IPython magic to ensure Python compatibility.
#@markdown ## Run ERSGAN on Uploaded Image
# %cd Real-ESRGAN
...
#@markdown ##Download Super Enhanced Image
...
#@markdown #**Optional Step 2) Generate a video from generated frames**
